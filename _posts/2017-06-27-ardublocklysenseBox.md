...
Unter [Arbublockly](https://blockly.sensebox.de/ardublockly/?board=sensebox-mcu&lang=de) befindet sich eine online Version der Oberfläche, die ohne Installation auf den gängigen Browsern läuft. Hierbei muss allerdings der generierte Code mittels Copy and Paste in die Arduino IDE kopiert werden.
