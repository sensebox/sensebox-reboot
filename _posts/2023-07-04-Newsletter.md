  ...
  <div id="sib-form-container" class="sib-form-container">
    ...
    <div id="success-message" class="sib-form-message-panel" style="font-size:16px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#085229; background-color:#e7faf0; border-radius:3px; border-color:#13ce66;max-width:540px;">
      <div class="sib-form-message-panel__text sib-form-message-panel__text--center">
        ...
        <span class="sib-form-message-panel__inner-text">
                          Ihre Anmeldung war erfolgreich. Wir freuen uns, dass Sie Neuigkeiten rund um die senseBox erhalten möchten!
                      </span>
      </div>
    </div>
    <div></div>
    <div id="sib-container" class="sib-container--large sib-container--vertical" style="text-align:center; background-color:rgba(255,255,255,1); max-width:540px; border-radius:3px; border-width:1px; border-color:#C0CCD9; border-style:solid; direction:ltr">
      <form id="sib-form" method="POST" action="https://e250efa4.sibforms.com/serve/MUIFAABOrl0N__j4MEGNqgphEXVwGmSBfxsyoplRPgb6RbTVBvBsAfD-bjS_CVWND9JBSP2XYDHi1oU2SzCxrkl-MtKQMdI8aC6SshcddBj63b0ozpi3vY6Zc08ny7yBjqyJAsxNBnsIlibzT-WwjzLK9ec70sQjHabrRsvJCoiJVZuKNcgbI8ZLVMdfBLqhr9yCW_h2FIPB0oee" data-type="subscription">
        <div style="padding: 8px 0;">
          <div class="sib-form-block sib-image-form-block" style="text-align: center">
            <a href="https://sensebox.de/" target="_blank">
              <img src="https://img.mailinblue.com/5540038/images/content_library/original/64317eb210245b47340366ca.png" style="width: 500px;height: 190px;" alt="" title="" />
            </a>
          </div>
        </div>
        <div style="padding: 8px 0;">
          <div class="sib-form-block" style="font-size:32px; text-align:left; font-weight:700; font-family:&quot;Helvetica&quot;, sans-serif; color:#3C4858; background-color:transparent; text-align:left">
            <p>senseBox-Newsletter</p>
          </div>
        </div>
        <div style="padding: 8px 0;">
          <div class="sib-form-block" style="font-size:16px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#3C4858; background-color:transparent; text-align:left">
            <div class="sib-text-form-block">
              <p>Melden Sie sich zu unserem Newsletter an, um auf dem Laufenden rund um die senseBox zu bleiben.</p>
            </div>
          </div>
        </div>
        <div style="padding: 8px 0;">
