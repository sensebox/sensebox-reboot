...
{% include image.html image=page.image4 %} 
Wenn man nun `/ledon` (bzw. `/ledoff`) eingibt, kann man die rote LED auf der Platine neben dem USB-Eingang an- oder ausschalten.
