...
```
Nun da das Messinterval definiert ist, müssen noch innerhalb des Intervalls die Messwerte auf der SD-Karte gespeichert werden. 
...
Nachdem du deine senseBox eine Weile Messwerte gesammelt hat, können die Messwerte auf die openSenseMap hochgeladen werden! 
...
Hast du den SD-Adapter mit deinem Computer verbunden, werden dir nun die Dateien auf der SD-Karte angezeigt. Unter den Dateien befindet sich auch die Datei `data.csv`. Kopiere diese auf deinen PC. 
