...
thumbnail:
image0: /images/projects/Hanagotchi/Aufbau.png
image1: /images/projects/Hanagochi/Setup.png
...
image5: /images/projects/Hanagotchi/normales_Hamagotchi.png
...
imgage13: /images/projects/Hanagotchi/Fertiger_TemperaturBlock.png
...
### Setup und Varaiblen
Zu allererst muss die LED-Matrix im Setup initialisiert werden. Falls du das Display mitbenutzen möchtest, musst du es auch noch initialisieren.
...
Sie dient dazu, zu erkennen, wann die Aktion bereits ausgeführt wurde, also nicht mehr nötig ist. Sie bewirkt aber auch, dass wenn der Wassergehalt im Topf wieder sinkt und du erneut deine Pflanze gießt, das Hanagotchi wieder kauen zu lassen. Die Variable musst du dafür jetzt an verschiedenen Stellen einsetzen: Als erstes musst du zurück zum Setup. Hier fügst du Die Variable ein und stellst die auf „Falsch“. Das heißt, dass wenn das Programm anfängt, die Aktion noch nicht ausgeführt wurde. Jetzt musst du zurück zu dem letzten Wenn-Dann-Block, wo die Bodenfeuchte definiert wurde. Hier fügst du jetzt eine weitere Wenn-Dann-Bedingung ein im noch leeren Mache-Bereich ein.
